...
The reusable theme for [Ghost](http://github.com/tryghost/ghost/). This is the latest development version of Ninja. If you're just looking to download the latest release, head over to the [releases](https://github.com/aNinjaMonk/ninjaTheme/releases) page.
...
Copyright (c) 2018-2020 Bahi Khata Inc. - Released under the [MIT license](LICENSE).
